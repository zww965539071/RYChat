...
- (void)setAutoLayout {
  RCTextMessage *testMessage = (RCTextMessage *)self.model.content;
  if (testMessage) {
...
+ (CGSize)getTextLabelSize:(RCTextMessage *)message {
...
+ (CGSize)getBubbleBackgroundViewSize:(RCTextMessage *)message {
