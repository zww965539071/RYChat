...
- (void)updateRealTimeLocationStatus{
    switch ([self.delegate getStatus]) {
        ...
        case RC_REAL_TIME_LOCATION_STATUS_IDLE://初始状态
            self.hidden = YES;
            self.isExpended = NO;
            break;
        case RC_REAL_TIME_LOCATION_STATUS_INCOMING://接收状态
            self.hidden = NO;
            self.isExpended = NO;
            [self setBackgroundColor:[UIColor colorWithRed:((float)0x11) / 255
                                                     ...
                                                     alpha:0.7]];
            break;
        case RC_REAL_TIME_LOCATION_STATUS_OUTGOING://发起状态
        case RC_REAL_TIME_LOCATION_STATUS_CONNECTED://共享状态
            self.hidden = NO;
            self.isExpended = NO;
